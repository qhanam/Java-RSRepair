...
public class SampleUse {
	...
	public static void main(String[] args) throws Exception {
		...
		JRSRepair repair = new JRSRepair(SOURCE_DIRECTORY, new File(FAULTY_COVERAGE), new File(SEED_COVERAGE), MUTATION_CANDIDATES, MUTATION_GENERATIONS, MUTATION_ATTEMPTS, RANDOM_SEED, testExecutor);
		repair.buildASTs();
		repair.repair();
	}
}